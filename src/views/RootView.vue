            ...
            <div class="modal-main bg-white w-11/12 mx-auto rounded-lg z-50 overflow-y-auto max-h-full">Modal
                ...
                <div v-if="showModal === 'step1'">
                    ...
                    <div class="pt-5 px-8">
                        ...
                        <p class="text-dark">This will not be shown publicly. Confirm your own age, even if this account is
                ...
                <div v-if="showModal === 'step4'">
                    ...
                    <div class="pt-5 px-8">
                        ...
                        <button @click="signMeUp"
                            class="w-full rounded-full mt-4 py-3 bg-blue text-white font-bold hover:bg-darkblue">Sign
                            up</button>
                    </div>
                </div>
