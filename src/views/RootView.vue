      ...
      <div class="modal-main bg-white w-11/12 max-w-md mx-auto rounded-lg z-50 overflow-y-auto max-h-full">
        <div v-if="showModal === 'step1'">
          <div class="pl-1 pr-4 py-1 h-12">
            <button @click="_setSignupStep('step2')"
              ...
              :class="`${!name || !email || !birthdate
                ? 'opacity-50 cursor-not-allowed'
                : ''
                }`">
              Next
            </button>
            <i class="flex justify-center fa-solid fa-kiwi-bird text-blue text-2xl mt-2 mb-8"></i>
          </div>
          <div class="pt-5 px-8">
        ...
        <div v-if="showModal === 'step2'">
          ...
          <div class="pt-5 px-8">
            ...
            <div class="mt-5 mb-8">
              <p class="font-bold text-xl mb-1">Get more out of Fitter</p>
              <div class="flex justify-between items-top">
                <p>
                  Receive email about your Fitter activity and recommendations.
                </p>
            ...
            <div class="mt-5 mb-8">
              ...
              <div class="flex justify-between items-top">
                <p>
                  Let others find your Fitter account by your email address.
                </p>
                <input class="mt-1 ml-2 mr-2" type="checkbox" />
              </div>
            </div>
            ...
            <div class="mt-5 mb-5">
              ...
              <div class="flex justify-between items-top">
                <p>
                  You will always see ads on Fitter based on your Fitter
                  activity. When this setting is enabled, Fitter may further
                  personalise ads from Fitter advertisers, on and off Fitter,
                  by combining your Fitter activity with other online activity
        ...
        <div v-if="showModal === 'step3'">
          <div class="pl-1 pr-4 py-1 h-12">
            ...
            <i class="flex justify-center fab fa-solid fa-kiwi-bird text-blue text-2xl mt-2 mb-8"></i>
          </div>
          <div class="pt-5 px-8">
        ...
        <div v-if="showModal === 'step4'">
          <div class="pl-1 pr-4 py-1 h-12">
            <button @click="_setSignupStep('step3')" class="absolute rounded-full p-2 pl-3 hover:bg-lightblue">
              <i class="fas fa-arrow-left text-blue"></i>
            </button>
        ...
        <div v-if="showModal === 'step5'">
          ...
          <div class="pt-5 px-8">
            ...
            <button @click="resendVerificationCode" class="text-blue pl-2 hover:underline">
