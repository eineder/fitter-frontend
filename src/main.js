...
Amplify.configure({
  Auth: {
    ...
    userPoolWebClientId: process.env.VUE_APP_AWS_APPSYNC_USER_POOL_WEB_CLIENT_ID,
...
const appConfig = {
  'aws_appsync_graphqlEndpoint': process.env.VUE_APP_AWS_APPSYNC_GRAPH_QL_ENDPOINT,
